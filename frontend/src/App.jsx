...
function HeroSection({ hospitals, onNearbyComputed, getRemainingSlots, registerBooking }) {
  ...
  return (
    <section className="relative mx-auto flex max-w-6xl flex-col items-center justify-center overflow-hidden px-4 pb-20 pt-12 sm:px-6 md:pb-24 md:pt-16">
      ...
      {bookingHospital && (
        <div className="fixed inset-0 z-40 flex items-end sm:items-center justify-center bg-slate-900/40 p-0 sm:p-4">
          <div className="w-full max-w-2xl sm:rounded-3xl rounded-t-[1.5rem] rounded-b-none bg-white p-3 pb-safe sm:p-6 max-h-[85vh] sm:max-h-[90vh] overflow-y-auto">
            ...
            >
              ...
              {selectedHospital && (
                <div className="fixed inset-0 z-40 flex items-end sm:items-center justify-center bg-slate-900/40 p-0 sm:p-2 nearby-overlay-backdrop">
                  <div className="w-full max-w-2xl sm:rounded-3xl rounded-t-[1.5rem] rounded-b-none bg-white p-1 pb-safe sm:p-2 max-h-[95vh] sm:max-h-[90vh] overflow-y-auto nearby-overlay-panel">
                    ...
                    <div className="mt-1 space-y-1 text-xs">
                      <div className="grid gap-1 md:grid-cols-[1.1fr,1fr] md:items-start">
                        <div>
                          <p className="text-[0.7rem] font-semibold text-slate-700">
                            1. Choose a date
                          </p>
